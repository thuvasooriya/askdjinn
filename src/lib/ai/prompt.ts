...
- Limit concurrent search requests to 3. Do not spawn more than 3 concurrent search calls at once; run more only if needed after reviewing the previous results and users need.
