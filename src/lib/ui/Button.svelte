<script lang="ts" module>
  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        primary: "gradient-primary text-[var(--color-primary-foreground)] shadow-float hover:shadow-glow",
        secondary: "bg-[var(--color-muted)] text-[var(--color-foreground)] hover:bg-[var(--color-surface-elevated)]",
